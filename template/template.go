...
import (
	...
	errors2 "github.com/senseyman/go-admin/modules/errors"
	"github.com/senseyman/go-admin/modules/language"
	"github.com/senseyman/go-admin/modules/logger"
	"github.com/senseyman/go-admin/modules/menu"
	...
	"github.com/senseyman/go-admin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/senseyman/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/senseyman/go-admin/blob/master/template/login/list.go
	GetAssetList() []string
