...
See [manual](https://github.com/senseyman/go-admin/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/senseyman/go-admin clone, so:

```bash

$ go get github.com/senseyman/go-admin
$ cd $GOPATH/src/github.com/senseyman/go-admin # GOPATH is $HOME/go by default.
...
Notice: `go get` return `package github.com/senseyman/go-admin: no Go files in /go/src/github.com/senseyman/go-admin` is normal.
...
* [Tasks](https://github.com/senseyman/go-admin/projects)
